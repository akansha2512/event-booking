...
<div class="container mt-4">
    <h2 class="text-dark mb-4"> Edit Event</h2>
            ...
            <form action="{{ route('events.update', $event->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="available_seats" class="form-control" value="{{ old('available_seats', $event->available_seats) }}" min="1" required>
                    </div>
                </div>
